...
var
  a: TAggLCLCanvas;
  minX, maxX, minY, maxY, cX, cY, kX, kY, XRange, YRange: double;
  w, h: integer;
  ...
  begin
    ...
    DrawAggString(a, M_TXT_LEFT, y - 4, FormatFloat('0.0000000E+00', f));
  end;
